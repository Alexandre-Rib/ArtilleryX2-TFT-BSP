...
// Convenience alias â€” callers use setFontSize, not the atlas directly
static inline void setFontSize(uint16_t size) { FontAtlas_SetSize(size); }

// Convenience alias â€” callers use getCharacterInfo
...
// Generic dispatch: string pointer â†’ _str, integer index â†’ _label
