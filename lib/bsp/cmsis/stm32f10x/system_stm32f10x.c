...
#define VECT_TAB_OFFSET  0x7000 /*!< Application starts at 0x08007000 (after bootloader). */
...
/**
  ...
  * @retval None
  */
/* Called by startup before main(). Sets VTOR immediately so any early IRQ hits
   our vector table, not the bootloader's. Clock setup happens later in main(). */
